...
<section id="productDetails" class="flex flex-row items-center justify-center pt-20">
  ...
  <div class="flex flex-col gap-y-12 text-start">
      <h1 class="text-6xl font-bold">SCUF Reflex Pro</h1>
      <h2 class="text-5xl font-semibold">$49</h2>
      <p class="max-w-lg text-xl">The custom PS5 controller built from the ground up to help you react faster & win more. Over 8 Hours of Active Gameplay. Pairs Well With Shooter, Action and Adventure Games.</p>
