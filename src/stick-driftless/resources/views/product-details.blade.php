...
<section id="productDetails" class="flex flex-row items-center justify-center pt-20 max-md:flex-col max-md:gap-y-8">
  ...
  <div class="flex flex-col gap-y-12 text-start max-md:px-6">
    ...
    <p class="max-w-lg text-xl">{{ $gamepad->description ?? 'The custom ' . $gamepad->platform . ' controller designed to help you react faster & win more. Over 8 Hours of Active Gameplay. Pairs Well With Shooter, Action and Adventure Games.' }}</p>
